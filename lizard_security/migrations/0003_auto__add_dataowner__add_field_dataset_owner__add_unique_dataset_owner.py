...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DataOwner'
        db.create_table('lizard_security_dataowner', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('remarks', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('lizard_security', ['DataOwner'])

        # Adding M2M table for field data_managers on 'DataOwner'
        db.create_table('lizard_security_dataowner_data_managers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dataowner', models.ForeignKey(orm['lizard_security.dataowner'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('lizard_security_dataowner_data_managers', ['dataowner_id', 'user_id'])

        # Adding field 'DataSet.owner'
        db.add_column('lizard_security_dataset', 'owner',
        ...
        db.create_unique('lizard_security_dataset', ['owner_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'DataSet', fields ['owner', 'name']
        db.delete_unique('lizard_security_dataset', ['owner_id', 'name'])

        # Deleting model 'DataOwner'
        db.delete_table('lizard_security_dataowner')

        # Removing M2M table for field data_managers on 'DataOwner'
        db.delete_table('lizard_security_dataowner_data_managers')

        # Deleting field 'DataSet.owner'
        db.delete_column('lizard_security_dataset', 'owner_id')
