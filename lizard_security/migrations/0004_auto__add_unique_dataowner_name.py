...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'DataOwner', fields ['name']
        db.create_unique('lizard_security_dataowner', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'DataOwner', fields ['name']
        db.delete_unique('lizard_security_dataowner', ['name'])
